...
@section('content')
        <h1>Sapori del Ticino</h1>
        <p class="subtitle">Le Meilleur du Tessin</p>
    ...
    <div class="section-up">
        <a href="#" class="section-left">
            <img src="{{ asset('img/proposition_2/miel.jpg') }}" alt="">
        ...
        <div class="section-right">
            <a href="#" class="section-small-item mb-3">
                <img src="{{ asset('img/proposition_2/blanc.jpg') }}" alt="">
            ...
            <a href="#" class="section-small-item mb-3">
                <img src="{{ asset('img/proposition_2/pates.png') }}" alt="">
                <div class="section-small-item-text">
            ...
            <a href="#" class="section-small-item">
                <img src="{{ asset('img/proposition_2/farine.png') }}" alt="">
                <div class="section-small-item-text">
            ...
            <a href="#" class="section-small-item">
                <img src="{{ asset('img/proposition_2/framboises.jpg') }}" alt="">
                <div class="section-small-item-text">
                    <h5>Framboises</h5>
                    <p>
                        De par chez nous
